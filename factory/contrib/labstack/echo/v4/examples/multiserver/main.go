...
import (
	...
	"github.com/xgodev/boost/factory/contrib/labstack/echo/v4/plugins/local/health"
	logplugin "github.com/xgodev/boost/factory/contrib/labstack/echo/v4/plugins/local/log"
	mserver "github.com/xgodev/boost/factory/contrib/labstack/echo/v4/plugins/local/multi-server"
	status "github.com/xgodev/boost/factory/contrib/labstack/echo/v4/plugins/local/restresponse"
