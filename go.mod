...
require (
	...
	github.com/mittwald/vaultgo v0.2.4
	...
	go.opentelemetry.io/contrib/instrumentation/go.mongodb.org/mongo-driver/v2/mongo/otelmongo v0.0.0-20250918223207-d53aded4ac52
