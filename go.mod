...
// replace github.com/confluentinc/confluent-kafka-go/v2 => github.com/confluentinc/confluent-kafka-go/v2 v2.10.1
// replace github.com/containerd/containerd/api => github.com/containerd/containerd v1.7.18
replace gopkg.in/DataDog/dd-trace-go.v1 => gopkg.in/DataDog/dd-trace-go.v1 v1.74.0
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/sfn v1.35.9 // indirect
