...
description: "Kafka (Confluent) subscriber adapter at github.com/xgodev/boost/bootstrap/function/adapter/contrib/confluentinc/confluent-kafka-go/v2 — consumer group, offset commit semantics, topic subscription. Apply when writing Kafka function consumers in a boost service. STATUS: stub — not yet lapidated via the TDD cycle. Treat as a placeholder routing to boost-core until first concrete usage forces a RED-GREEN-REFACTOR pass."
...
Kafka (Confluent) subscriber adapter at github.com/xgodev/boost/bootstrap/function/adapter/contrib/confluentinc/confluent-kafka-go/v2 — consumer group, offset commit semantics, topic subscription. Apply when writing Kafka function consumers in a boost service.
