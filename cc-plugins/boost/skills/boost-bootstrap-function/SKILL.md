...
description: "Generic function bootstrap on github.com/xgodev/boost/bootstrap/function — function.New[T], fn.Run, Handler[T] = func(context.Context, cloudevents.Event) (T, error), function.Wrapper, generic-parameter discipline (T = *cloudevents.Event throughout the chain). Apply when writing event-driven function consumers regardless of transport. STATUS: stub — not yet lapidated via the TDD cycle. Treat as a placeholder routing to boost-core until first concrete usage forces a RED-GREEN-REFACTOR pass."
...
Generic function bootstrap on github.com/xgodev/boost/bootstrap/function — function.New[T], fn.Run, Handler[T] = func(context.Context, cloudevents.Event) (T, error), function.Wrapper, generic-parameter discipline (T = *cloudevents.Event throughout the chain). Apply when writing event-driven function consumers regardless of transport.
