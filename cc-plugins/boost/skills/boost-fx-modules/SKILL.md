...
description: "Dependency injection via github.com/xgodev/boost/fx/modules — Module() functions returning fx.Option, fx.Provide / fx.Invoke patterns, group:"..." tags for middleware collection, optional:"true" for opt-in deps, lifecycle hooks. Apply when scaling beyond a single main.go to module-composed apps. STATUS: stub — not yet lapidated via the TDD cycle. Treat as a placeholder routing to boost-core until first concrete usage forces a RED-GREEN-REFACTOR pass."
...
Dependency injection via github.com/xgodev/boost/fx/modules — Module() functions returning fx.Option, fx.Provide / fx.Invoke patterns, group:"..." tags for middleware collection, optional:"true" for opt-in deps, lifecycle hooks. Apply when scaling beyond a single main.go to module-composed apps.
